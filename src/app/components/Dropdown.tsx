    ...
    <div>
      ...
      >
        <div
          ...
          data-tracking-uuid="675f6c18-e480-4bb2-ba96-619e0585c820"
        >
            ...
            <li className="sub-menu-item profile" role="listitem">
              <div>
                <a
                  ...
                  tabindex="0"
                  href="/SwitchProfile?tkn=DBR5CYDESZEHJB2TZUGZB5VDL4"
                ...
                >
                  ...
                  <span className="profile-name">프로필네임</span>
                </a>
                <div className="profile-children"></div>
              </div>
            </li>
          </ul>
          <ul className="sub-menu-list responsive-links">
            <li className="sub-menu-item kids-responsive-link">
              <button
                className="kids-responsive-link-button"
                role="link"
                tabindex="0"
              >
                키즈
          ...
          <ul className="account-links sub-menu-list" aria-label="계정">
            ...
            <li className="sub-menu-item">
              <a
                className="sub-menu-link sub-menu-link-icon"
                href="/account/profile/transfer/4VQJEGIMF5GCFIKYUHWPP7BPGQ"
              >
                <svg
                  id="profile-transfer"
                  width="24"
          ...
          <ul className="sub-menu-list sign-out-links">
            <li className="sub-menu-item">
              <a className="sub-menu-link " href="/SignOut?lnkctr=mL">
                넷플릭스에서 로그아웃
              </a>
            </li>
          </ul>
